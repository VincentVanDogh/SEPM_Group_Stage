...
public class SecurityTest implements TestData {
    ...
    @Test
    @Transactional
    public void givenUserLoggedIn_whenFindUnread_then200() throws Exception {
        ...
        MvcResult mvcResult = this.mockMvc.perform(get(MESSAGE_BASE_URI + "/unread")
    ...
    @Test
    @Transactional
    public void givenNoOneLoggedIn_whenFindUnread_then401() throws Exception {
        MvcResult mvcResult = this.mockMvc.perform(get(MESSAGE_BASE_URI + "/unread"))
            .andDo(print())
            .andReturn();
        MockHttpServletResponse response = mvcResult.getResponse();
